...
import com.alhasawi.acekuwait.databinding.FragmentSearchedProductListingBinding;
...
import com.alhasawi.acekuwait.ui.main.view.dashboard.product.paging.ProductPagedListAdapter;
...
public class SearchedProductListFragment extends BaseFragment implements RecyclerviewSingleChoiceClickListener, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private FragmentSearchedProductListingBinding fragmentProductListingBinding;
    private String languageId = "";

    @Override
    protected int getLayoutResId() {
        return R.layout.fragment_searched_product_listing;
    }

    @Override
    protected void setup() {
        fragmentProductListingBinding = (FragmentSearchedProductListingBinding) viewDataBinding;
        ...
        productPagedListAdapter = new ProductPagedListAdapter(getContext()) {
            ...
            public void onItemClicked(Product productContent) {
                try {
                    ...
                    try {
                        logSearchProductEvent(selectedProduct.getProductId(), selectedProduct.getDescriptions().get(0).getProductName(), searchQuery);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
