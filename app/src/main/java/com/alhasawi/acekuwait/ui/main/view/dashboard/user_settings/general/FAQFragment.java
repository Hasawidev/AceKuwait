...
public class FAQFragment extends BaseFragment {
    ...
    protected void setup() {
        ...
        fragmentDynamicContentBinding.tvTitle.setText(AceHardware.appContext.getString(R.string.faq));
        fragmentDynamicContentBinding.imageViewcontent.setImageDrawable(getResources().getDrawable(R.drawable.faq_big));
        getContent();
    ...
    private void getContent() {
        ...
        dynamicContentViewModel.getDynamicWebviewContent(AppConstants.FAQ, languageId).observe(this, dynamicContentResponseResource -> {
            switch (dynamicContentResponseResource.status) {
                case SUCCESS:
                    if (dynamicContentResponseResource.data.getStatusCode() == 200) {
                        ...
                        GeneralDialog generalDialog = new GeneralDialog(getContext().getResources().getString(R.string.error), dynamicContentResponseResource.data.getMessage());
                ...
                case LOADING:
                    break;
                case ERROR:
                    GeneralDialog generalDialog = new GeneralDialog(getContext().getResources().getString(R.string.error), dynamicContentResponseResource.message);
                    generalDialog.show(getParentFragmentManager(), "GENERAL_DIALOG");
                    break;
            }
