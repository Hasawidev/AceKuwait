...
import com.alhasawi.acekuwait.databinding.LayoutFilterValueItemBinding;
        ...
        holder.filterValueBinding.checkBoxFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (((AppCompatCheckBox) view).isChecked()) {
                    ...
                    holder.filterValueBinding.checkBoxFilter.setTextColor(context.getResources().getColor(R.color.ace_theme_color));
                    ...
                    holder.filterValueBinding.checkBoxFilter.setTextColor(context.getResources().getColor(R.color.black));
                    if (selectedFiltersList.contains(filterAttributeValues))
